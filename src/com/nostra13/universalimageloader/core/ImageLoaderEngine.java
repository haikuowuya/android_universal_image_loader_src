...
/**
 * 负责加载和显示图片任务
 * {@linkplain com.nostra13.universalimageloader.core.LoadAndDisplayImageTask LoadAndDisplayImageTask}
 * 的执行引擎,通过 {@linkplain com.nostra13.universalimageloader.core.ImageLoaderConfiguration ImageLoaderConfiguration } 进行参数配置
 */
class ImageLoaderEngine
{
	/**{@link ImageLoaderConfiguration}对象*/
